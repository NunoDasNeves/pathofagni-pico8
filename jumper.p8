...
thang_dat = {
	...
	[192] = { -- knight
		...
		cy = 1,
		-- copied from thrower
		atkrange = 8*2, -- only attack player in this range
		s_idle = {s=0, f=0},
		s_wlk  = {s=1, f=2},
		s_atk  = {s=3, f=3},
		s_jmp  = {s=6, f=2},
...
function update_knight(t)
	...
	if (t.atking) then
		t.s = t.i + t.s_atk.s
		if (play_anim(t, 5, t.s_atk.f)) then
			t.atking = false
			t.fcnt = 0
			t.fr = 0
		end	
...
420000000000000000000000000000253100001000000000001000420000000232615200000000000000000000000002e00000000c0000000000000000000002
...
42000000000000000000000000656541320000000000000000000042000000023261520000000000000000000000000200000000000000000000000000000002
...
42000065000000650000006500000042320000000000000000000043000000023261520000100000000010000000100231203030400000000000002030304002
...
43000052000000520000004200000042320000000000000000000000000000023261520000000000000000000030300232000000203030303030304000000002
...
e0000052000000520000004200000042320000000000000000100000002500023261520000000030303030000000000232304000000000000000000000203002
...
2892ddf02892ddf02892ddf02892f00022fddddd2fdddddf2982dd602892ddf002982d6006ddd2208ea8ea002892df472982dd0000000000f400000046770000
...
022005000225500002250500022005000205005002500500298255f002250050029825f000f4677008800e000220050029825f47029892dd0000000000000000
