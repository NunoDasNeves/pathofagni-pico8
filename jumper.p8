...
rain_patterns = {0b10111010101011110.1,0b1110101110101010.1,0b1010111010111010.1,0b1010101011101011.1}
function draw_rain(t)
	fillp(rain_patterns[t.fr+1])
	rectfill(t.x,t.y,t.x+t.w-1,t.y+t.h,1)
	fillp()
	for i=-1,t.h\8-1 do
		spr(123,t.x,i*8+t.fr*2)
	end
	spr(235,t.x,t.h-8+t.fr\2)
end
...
function update_p()
	...
	if btn(❎) then
		...
		for t in all(thang) do
			if t.i == 257 and coll_p(t.x,t.y,t.w,t.h) then
				p.sh = false
			end
		end
		if p.sh then
...
0000000000000000000000b0bb00000000000e00000666000006660000066c0000066600000666c00eee080010000010bbbb0c7015111151151d155111111111
